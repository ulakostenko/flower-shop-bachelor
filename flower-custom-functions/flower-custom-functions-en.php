<?php
/**
 * The main functions of the timer and discounts.
 *
 * @package WordPress_Custom_plugin
 * @pluginname Flower Shop - Custom Functions
 * @Description Cateptome features for the flower online store.
 * @version 1.0
 * @Author Kostenko Julia
 */

/**
 * Shows the SVG-Timer by the end of the action.
 *
 * @param array $ atts attributes shortcode.
 * @return string html timer or message.
 */
...
/**
 * SHORT code registration for a timer withdrawal
 */
...
/**
 * Discount when buying 3+ bouquets.
 *
 * @param wc_cart $ Cart buyer basket.
 * @return void
 */
...
/**
 * Registration of discount on the cart when calculating the value
 */
